...
**Keeping dream notes.** Sixty-six dream-note files across sixty-four dates, including two evening notes — the sessions, the patterns, the seeds. The practice has become its own thing. The latest holds a completed recovery beside a much slower gift carried through fiction and naming, while the machine underneath both reaches an urgent capacity limit.
